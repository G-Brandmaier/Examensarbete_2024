        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpenProfile = table.Column<bool>(type: "bit", nullable: false),
                    MemberSince = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProfileWatchListItem", x => new { x.UserProfileId, x.WatchListItemId });
                    table.ForeignKey(
                        name: "FK_UserProfileWatchListItem_UserProfile_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProfileWatchListItem_WatchListItem_WatchListItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProfileWatchListItem_WatchListItemId",
                table: "UserProfileWatchListItem",
